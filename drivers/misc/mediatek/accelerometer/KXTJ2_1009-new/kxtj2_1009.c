...
static struct i2c_board_info __initdata i2c_kxtj2_1009 = {
    I2C_BOARD_INFO(KXTJ2_1009_DEV_NAME, (KXTJ2_1009_I2C_SLAVE_ADDR >> 1)) };
...
static int KXTJ2_1009_SetDataResolution(struct kxtj2_1009_i2c_data *obj)
{
	...
	if (hwmsen_read_block(obj->client, KXTJ2_1009_REG_DATA_RESOLUTION, databuf, 0x01)) {
		GSE_LOG("kxtj2_1009 read Dataformat failt\n");
...
static int kxtj2_1009_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	obj->early_drv.level = EARLY_SUSPEND_LEVEL_DISABLE_FB - 1,
	    ...
	    obj->early_drv.resume = kxtj2_1009_late_resume, register_early_suspend(&obj->early_drv);
#endif
