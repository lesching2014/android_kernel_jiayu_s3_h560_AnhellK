...
static int gsensor_get_data(int* x ,int* y,int* z, int* status)
{
	...
	*status = SENSOR_STATUS_ACCURACY_MEDIUM;
	...
	if((obj_i2c_data->oldData[0] == *x ) || (obj_i2c_data->oldData[1] == *y ) || (obj_i2c_data->oldData[2] == *z ))
	{
		obj_i2c_data->oldData[0] = *x+1;
		obj_i2c_data->oldData[1] = *y+1;
		obj_i2c_data->oldData[2] = *z+1;
		*x += 1;
		*y += 1;
		*z += 1;
	}
	...
	{
		obj_i2c_data->oldData[0] = *x;
		obj_i2c_data->oldData[1] = *y;
		obj_i2c_data->oldData[2] = *z;
	}
	*status = SENSOR_STATUS_ACCURACY_MEDIUM;
#endif
	return 0;
