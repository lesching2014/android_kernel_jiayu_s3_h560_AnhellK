...
#define AF_DRVNAME "DW9761OFILMAF"
#define I2C_SLAVE_ADDRESS        0x18
#define I2C_REGISTER_ID            0x19 //lenovo.sw wangsx3 change the i2c id for different i2c_baord_info
#define PLATFORM_DRIVER_NAME "lens_actuator_dw9761ofilmaf"
#define AF_DRIVER_CLASS_NAME "actuatordrv_dw9761ofilmaf"
...
inline static int getAFInfo(__user stDW9761OFILMAF_MotorInfo * pstMotorInfo)
{
    stDW9761OFILMAF_MotorInfo stMotorInfo;
    ...
    if(copy_to_user(pstMotorInfo , &stMotorInfo , sizeof(stDW9761OFILMAF_MotorInfo)))
    {
...
unsigned long a_u4Param)
{
    ...
    switch(a_u4Command)
    {
        case DW9761OFILMAFIOC_G_MOTORINFO :
            i4RetValue = getAFInfo((__user stDW9761OFILMAF_MotorInfo *)(a_u4Param));
        break;

        case DW9761OFILMAFIOC_T_MOVETO :
            i4RetValue = moveAF(a_u4Param);
        break;
 
        case DW9761OFILMAFIOC_T_SETINFPOS :
            i4RetValue = setAFInf(a_u4Param);
        break;

        case DW9761OFILMAFIOC_T_SETMACROPOS :
...
static int __init DW9761SUNNYAF_i2C_init(void)
{
...
static void __exit DW9761SUNNYAF_i2C_exit(void)
{
	platform_driver_unregister(&g_stAF_Driver);
}

module_init(DW9761SUNNYAF_i2C_init);
module_exit(DW9761SUNNYAF_i2C_exit);

MODULE_DESCRIPTION("DW9761AF lens module driver");
