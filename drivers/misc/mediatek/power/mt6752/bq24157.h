...
extern kal_uint32 bq24157_get_otg_status(void);
extern void bq24157_set_en_stat(kal_uint32 val);
extern kal_uint32 bq24157_get_chip_status(void);
extern kal_uint32 bq24157_get_boost_status(void);
extern kal_uint32 bq24157_get_fault_status(void);
//CON1----------------------------------------------------
extern void bq24157_set_input_charging_current(kal_uint32 val);
extern void bq24157_set_v_low(kal_uint32 val);
...
//CON2----------------------------------------------------
extern void bq24157_set_oreg(kal_uint32 val);
...
extern kal_uint32 bq24157_get_pn(void);
extern kal_uint32 bq24157_get_revision(void);
//CON4----------------------------------------------------
extern void bq24157_set_reset(kal_uint32 val);
extern void bq24157_set_iocharge(kal_uint32 val);
extern void bq24157_set_iterm(kal_uint32 val);
//CON5----------------------------------------------------
extern void bq24157_set_dis_vreg(kal_uint32 val);
extern void bq24157_set_io_level(kal_uint32 val);
extern kal_uint32 bq24157_get_sp_status(void);
extern kal_uint32 bq24157_get_en_level(void);
extern void bq24157_set_vsp(kal_uint32 val);
//CON6----------------------------------------------------
extern void bq24157_set_i_safe(kal_uint32 val);
extern void bq24157_set_v_safe(kal_uint32 val);
//---------------------------------------------------------
extern void bq24157_dump_register(void);
extern kal_uint32 bq24157_reg_config_interface (kal_uint8 RegNum, kal_uint8 val);

extern kal_uint32 bq24157_read_interface (kal_uint8 RegNum, kal_uint8 *val, kal_uint8 MASK, kal_uint8 SHIFT);
extern kal_uint32 bq24157_config_interface (kal_uint8 RegNum, kal_uint8 val, kal_uint8 MASK, kal_uint8 SHIFT);
