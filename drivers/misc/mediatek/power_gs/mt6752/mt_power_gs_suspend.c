...
extern unsigned int *MT6325_PMIC_REG_gs_flightmode_suspend_mode;
...
void mt_power_gs_dump_suspend(void)
{
    mt_power_gs_compare("Suspend",                                \
			MT6325_PMIC_REG_gs_flightmode_suspend_mode, MT6325_PMIC_REG_gs_flightmode_suspend_mode_len);
