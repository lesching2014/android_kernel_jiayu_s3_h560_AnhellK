...
/* Vanzo:zhangqingzhan on: Tue, 23 Dec 2014 18:12:25 +0800
    * TODO:for h560 flash light 
     */
/*******************************************************************************
 * iReadRegI2C_fl
 ********************************************************************************/
int iReadRegI2C_fl(u8 *a_pSendData , u16 a_sizeSendData, u8 * a_pRecvData, u16
    a_sizeRecvData, u16 i2cId)
{
  int  i4RetValue = 0;
  spin_lock(&kdsensor_drv_lock);
  g_pstI2Cclient2->addr = (i2cId >> 1);
  ...
  i4RetValue = i2c_master_recv(g_pstI2Cclient2, (char *)a_pRecvData,
      a_sizeRecvData);
...
/* Vanzo:zhangqingzhan on: Tue, 23 Dec 2014 18:13:29 +0800
 * TODO:for h560 flashlight read 
 */
/*******************************************************************************
 * iWriteRegI2C_fl
 ********************************************************************************/
int iWriteRegI2C_fl(u8 *a_pSendData , u16 a_sizeSendData, u16 i2cId)
{
  int  i4RetValue = 0;
  int retry = 3;
